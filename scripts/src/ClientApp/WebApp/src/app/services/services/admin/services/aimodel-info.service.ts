...
import { AIModelInfoFilterDto } from '../models/model-mod/aimodel-info-filter-dto.model';
import { PageList } from '../models/perigon/page-list.model';
import { AIModelInfoItemDto } from '../models/model-mod/aimodel-info-item-dto.model';
import { AIModelInfoAddDto } from '../models/model-mod/aimodel-info-add-dto.model';
import { AIModelInfo } from '../models/entity/aimodel-info.model';
import { AIModelInfoUpdateDto } from '../models/model-mod/aimodel-info-update-dto.model';
import { AIModelInfoDetailDto } from '../models/model-mod/aimodel-info-detail-dto.model';
/**
 * 模型信息
 */
