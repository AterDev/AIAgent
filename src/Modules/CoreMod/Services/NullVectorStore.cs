...
/// 向量存储占位实现
/// </summary>
public class NullVectorStore : Share.Services.IVectorStore
{
    ...
    public Task DeleteChunksAsync(IEnumerable<Guid> chunkIds, CancellationToken cancellationToken = default)
    {
        return Task.CompletedTask;
    }
}
